...
module.exports = {
  ...
  parseData(table, obj) {
    ...
    Object.keys(obj)
      .filter((e) => obj[e] != null && attrs[e])
      .forEach((e) => {
        if (
          obj[e] === "" &&
          (attrs[e].allowNull === undefined || attrs[e].allowNull)
        ) {
          obj[e] = null;
  ...
  formatTime(value) {
    return moment
      .utc(value, typeof value == "string" ? "HH:mm:ss" : null)
  ...
  formatData(field, next) {
    if (
      next.toString() == "function() { return packet.readLengthCodedBuffer() }"
    ) {
      if (field.type == "BIT") {
